...
<?php echo'<form action="dodaj_kucu.php" method="POST" enctype = "multipart/form-data">
    ...
    <script>
      ...
      // <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1v9GwfVESZsR6czrUvVVn2DjiWyVclRg&libraries=places">
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1v9GwfVESZsR6czrUvVVn2DjiWyVclRg&libraries=places&callback=initAutocomplete"
         async defer></script>
